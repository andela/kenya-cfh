...
class Game {
   ...
   * 
   * @param {*} thisPlayer
   * @returns {*} _findPlayerIndexBySocket
   */
  ...
  removePlayer(thisPlayer) {
    ...
    // Just used to send the remaining players a notification
      ...
      // Update the czar's position if the r
      // emoved player is above the current czar
