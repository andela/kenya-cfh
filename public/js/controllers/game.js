angular.module('mean.system').controller('GameController', [
  ...
  ($scope, game, $timeout, $location, MakeAWishFactsService) => {
    ...
    $scope.gameTour.setOptions({
      ...
      {
        element: '#invite-player-button-container',
        intro: 'Inviteplayers to join you in the game'
      },
      {
        element: '#chat_window_1',
        intro: 'Feel free to chat with other players',
        position: 'top'
      },
      {
        element: '#social-bar-container',
        intro: 'Meet those you are playing game with'
      },
      {
